...
import io
from search_engine import SearchByImageInstance
from googleapiclient.discovery import build
from googleapiclient.errors import HttpError
from googleapiclient.http import MediaIoBaseUpload

API_KEY = "AIzaSyCylV7xSDD0t-oYOGvfCSf5ydSENp15uRo"
...
# https://github.com/thanhson28/icme2023/commit/7f44c423ebfdb8cea6e9703499a7cee7d9968058
def check_famous(queries):
    """Check the fame of the news sources."""
    host_page_urls = [query["link"] for query in queries]
    return any(
        page_url in host
        for page_url in FAMOUS_PAGES
        for host in host_page_urls
    )


drive_image_file_id = "1GGm5BPT4Q355LrsnDNlURlXHWwM1qNz2"
data = SearchByImageInstance().search(
    "https://drive.google.com/uc?id=" + str(drive_image_file_id),
    limit_page=5,
)
print("data :", data)
